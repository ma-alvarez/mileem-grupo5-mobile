...
import com.mileem.util.twitter.Twitter_Handler;
import com.mileem.util.twitter.Twitter_Handler.TwDialogListener;
...
public class Twitt_Sharing {
	...
	class PostTwittTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute() {
			...
			pDialog.setMessage("Compartiendo la publicación en Twitter...");
		...
		protected String doInBackground(String... twitt) {
			try {
				...
				e.printStackTrace();
				return "La publicación no pudo ser compartida.";
			}
